# -*- coding: utf-8 -*-
"""生成 GBK(CP936) + CRLF 编码的 .bat 文件，避免 cmd 中文乱码。

用法：python scripts/_gen_bat.py
仅用于修复 start-dev.bat / stop-dev.bat 的编码与解析问题。
"""
...
if __name__ == "__main__":
    write_bat("start-dev.bat", START)
    write_bat("stop-dev.bat", STOP)
