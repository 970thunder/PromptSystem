...
DISK_WARN=${PROMPTOS_DISK_WARN:-70}
DISK_HIGH=${PROMPTOS_DISK_HIGH:-80}
DISK_CRITICAL=${PROMPTOS_DISK_CRITICAL:-90}
MEM_MIN_MB=${PROMPTOS_MEM_MIN_MB:-500}
CERT_MIN_DAYS=${PROMPTOS_CERT_MIN_DAYS:-14}
