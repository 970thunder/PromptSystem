...
- 同步服务器总说明与 PromptOS 迭代清单：记录 2026-09-04 线上资源、Compose/卷/端口事实，修正 RustFS 当前 bridge 地址，并明确 28 项待办的生产验收门槛
- 修正服务器适配清单与实际 TODO 状态的漂移，按本机代码、外部依赖与数据、低内存运维、发布治理四类列出 28 项待完成工作，并更新 53 项完成基线
