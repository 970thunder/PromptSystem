...
- 同步服务器总说明与 PromptOS 迭代清单：记录 2026-09-04 线上资源、Compose/卷/端口事实，修正 RustFS 当前 bridge 地址，并明确 27 项待办的生产验收门槛
- 在服务器总说明增加完整 81 项迭代矩阵，按 P0、架构、数据、安全、前端、运维和发布逐项标注状态、执行层与服务器门槛；同步完成基线为 54 项
